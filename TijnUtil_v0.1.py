"""TijnUtility by Tijndagamer/MrTijn
...
eMailAddr = "@gmail.com"  # GMail adress goes here
...
def dance():  # The new dance function is made by: Pietdagamer
...
def emailsendtemp():
    ...
    toAddr = raw_input(">Receiver address =")
    subject = raw_input(">Subject =")
    header = "To: {}\n" + "From: {}\n\n" + "Subject: {}".format(toAddr, eMailAddr, subject)
    body = temp
    print("Your email is:")
    print(header + "\n" + body)
    time.sleep(0.5)
